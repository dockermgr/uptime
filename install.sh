...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410020922-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Oct 02, 2024 09:22 EDT
# @@File             :  install.sh
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export APPNAME="uptime"
export VERSION="202410020922-git"
...
DOCKER_REGISTRY_REPO_NAME="uptime"
...
CONTAINER_WEB_SERVER_VHOSTS="status.all"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
